...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = ["", "/juegos", "/juegos/mayor-o-menor", "/juegos/adivina-jugador", "/juegos/adivina-escudo", "/juegos/carrera", "/juegos/trivia", "/juegos/football-grid", "/beta", "/privacidad", "/cookies", "/aviso-legal"];
