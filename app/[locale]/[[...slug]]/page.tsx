...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const pages: Record<string, { title?: string; description?: string; noindex?: boolean }> = {
    ...
    "/beta": { title: d.beta.title, description: d.beta.intro }, "/privacidad": { title: d.legal.privacy.title }, "/cookies": { title: d.legal.cookies.title }, "/aviso-legal": { title: d.legal.notice.title },
  };
...
export default async function LocalizedPage({ params }: Props) {
  ...
  if (path === "") return <main><AdSlot placement="home-top" /><section className="hero hero--interactive"><div className="hero-content"><div className="hero-brand-lockup"><img className="hero-shield" src="/brand/10thegoat-shield-raster.png" alt=""/><img className="hero-wordmark" src="/brand/10thegoat-wordmark.svg" alt={d.home.alt}/><img className="hero-shield hero-shield--mirror" src="/brand/10thegoat-shield-raster.png" alt=""/></div><ArenaGameMenu games={games} locale={locale} label={d.home.intro}/></div></section><AdSlot placement="home-bottom" /></main>;
