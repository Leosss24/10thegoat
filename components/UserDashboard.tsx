...
const GAME_NAMES:Record<string,[string,string,string]> = {
  ...
  "el-intruso-easy":["EL INTRUSO · FÁCIL","ODD ONE OUT · EASY","L'INTRUS · FACILE"],
  "el-intruso-hard":["EL INTRUSO · DIFÍCIL","ODD ONE OUT · HARD","L'INTRUS · DIFFICILE"],
  "conexiones":["CONEXIONES","CONNECTIONS","CONNEXIONS"],
  "ordena-historia":["ORDENA LA HISTORIA","ORDER HISTORY","ORDONNEZ L'HISTOIRE"],
