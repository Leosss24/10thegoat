...
function run(seed,strategyName){
  const strategy=strategies[strategyName],nationality=nationalities[seed%nationalities.length],starters=starterClubsFor(nationality,CAREER_CLUBS),club=starters[seed%Math.max(1,starters.length)]??CAREER_CLUBS[seed%CAREER_CLUBS.length];
