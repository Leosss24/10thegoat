...
export const dictionaries = {
  es: {
    languageName: "Español", nav: { home: "Inicio", games: "Juegos", beta: "El proyecto", main: "Navegación principal", legal: "Información legal", privacy: "Privacidad", cookies: "Cookies", notice: "Aviso legal", feedback: "El proyecto", language: "Idioma" },
    ...
    status: { available: "Ya disponible", beta: "Ya disponible", soon: "Próximamente" },
    games: {
    ...
    legal: {
      ...
      privacy: legalCopy.es.privacy, cookies: legalCopy.es.cookies, notice: { title: "Aviso legal", sections: [["", "10theGOAT es un proyecto independiente de juegos de conocimiento futbolístico."], ["Contenido", "Los nombres, marcas, escudos e imágenes de terceros pertenecen a sus respectivos titulares y se muestran con finalidad informativa e identificativa. 10theGOAT no afirma estar asociado, patrocinado ni respaldado por clubes, competiciones o futbolistas."], ["Uso del servicio", "Los juegos se ofrecen con fines informativos y de entretenimiento. Las puntuaciones no tienen valor económico y no constituyen apuestas ni premios monetarios."]] }
    },
    notFound: { title: "Fuera de juego.", body: "Esta página no existe o todavía no ha salido al campo.", back: "Volver al inicio" }
  },
  en: {
    languageName: "English", nav: { home: "Home", games: "Games", beta: "The project", main: "Main navigation", legal: "Legal information", privacy: "Privacy", cookies: "Cookies", notice: "Legal notice", feedback: "The project", language: "Language" },
    ...
    catalog: { title: "All games" }, status: { available: "Available now", beta: "Available now", soon: "Coming soon" },
    games: {
    ...
    legal: { eyebrow: "Site information", privacy: legalCopy.en.privacy, cookies: legalCopy.en.cookies, notice: { title: "Legal notice", sections: [["", "10theGOAT is an independent football knowledge games project."], ["Content", "Third-party names, trademarks, badges and images belong to their respective owners and appear for information and identification. 10theGOAT does not claim association, sponsorship or endorsement by clubs, competitions or players."], ["Use of the service", "The games are provided for information and entertainment. Scores have no monetary value and do not constitute betting or cash prizes."]] } },
    notFound: { title: "Offside.", body: "This page does not exist or has not taken the field yet.", back: "Back to home" }
  },
  fr: {
    languageName: "Français", nav: { home: "Accueil", games: "Jeux", beta: "Le projet", main: "Navigation principale", legal: "Informations légales", privacy: "Confidentialité", cookies: "Cookies", notice: "Mentions légales", feedback: "Le projet", language: "Langue" },
    ...
    catalog: { title: "Tous les jeux" }, status: { available: "Disponible", beta: "Disponible", soon: "Bientôt disponible" },
    games: {
    ...
    legal: { eyebrow: "Informations du site", privacy: legalCopy.fr.privacy, cookies: legalCopy.fr.cookies, notice: { title: "Mentions légales", sections: [["", "10theGOAT est un projet indépendant de jeux de connaissances footballistiques."], ["Contenu", "Les noms, marques, écussons et images de tiers appartiennent à leurs propriétaires respectifs et sont présentés à titre informatif et d'identification. 10theGOAT ne revendique aucune association ni approbation de clubs, compétitions ou joueurs."], ["Utilisation du service", "Les jeux sont proposés à titre informatif et de divertissement. Les scores n'ont aucune valeur monétaire et ne constituent ni pari ni prix en espèces."]] } },
